...
export default function VKXModalPage() {
  ...
  const backdrops: Array<"opaque" | "blur" | "transparent"> = [
    "opaque",
    "blur",
    "transparent",
  ];
  ...
  return (
    <div className="flex w-full flex-col gap-y-10 pb-8">
      ...
      <p>
        Là một thành phần dùng để hiển thị hộp thoại hoặc cửa sổ nổi bật trên
        trang web. Modal thường được sử dụng để hiển thị thông báo, xác nhận
        hành động, hoặc cung cấp thông tin bổ sung mà không làm mất đi ngữ cảnh
        của trang hiện tại.
      </p>
      ...
      <div>
        ...
        <ul className="mt-4 flex flex-col gap-y-2">
          <li>
            Hiển thị hộp thoại có nội dung tùy chỉnh cần chú ý hoặc cung cấp
            thông tin bổ sung.
          </li>
          <li>
            Modal: Đây là thành phần chính để hiển thị một hộp thoại Modal.
          </li>
          <li>
            ModalContent: Là wrapper (thành phần bao bọc) cho các thành phần con
            khác của Modal (Header, Body, Footer).
          </li>
          <li>
            ModalHeader: Phần tiêu đề của Modal, thường chứa tiêu đề và nút
            đóng.
          </li>
          <li>
            ModalBody: Phần thân chính của Modal, nơi chứa nội dung của bạn.
          </li>
          <li>
            ModalFooter: Phần chân của Modal, thường chứa các nút hành động như
            "Xác nhận", "Hủy bỏ".
          </li>
        </ul>
      </div>
      ...
      <div>
        ...
        <ul className="mt-4 flex flex-col gap-y-2 mb-4">
          <li>
            Tiêu điểm (focus) sẽ tự động di chuyển vào phần tử có thể tương tác
            đầu tiên bên trong Modal.
          </li>
          <li>
            Người dùng không thể tương tác với nội dung bên ngoài/phía sau Modal
            khi nó đang mở.
          </li>
        </ul>
      ...
      <div>
        ...
        <p className="mb-3">
          Kích thước của Modal có thể được điều chỉnh bằng cách sử dụng thuộc
          tính size. Bạn có thể chọn giữa các kích thước như xs, sm, md, lg, xl,
          full. Mặc định là md.
        </p>
        <div>
      ...
      <div>
        ...
        <p className="mb-3">
          Vị trí của Modal có thể được điều chỉnh bằng cách sử dụng thuộc tính
          placement. Bạn có thể chọn giữa các vị trí như auto, center, top,
          bottom. Mặc định là auto.
        </p>
        <div>
          <div className=" flex flex-col gap-y-4">
            ...
            <RadioGroup
              ...
              onValueChange={(value) =>
                setModalPlacement(value as "auto" | "center" | "top" | "bottom")
              }
            >
            ...
            >
              <p>Modal demo về vị trí hiển thị</p>
              <p>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam
                pulvinar risus non risus hendrerit venenatis. Pellentesque sit
                amet hendrerit risus, sed porttitor quam.
      ...
      <div>
        ...
        <p className="mb-3">
          Thanh cuộn có thể được đặt bên trong hoặc bên ngoài modal. Nếu bạn
          muốn thanh cuộn nằm bên trong modal, hãy để scroll behavior là inside.
          Nếu bạn muốn thanh cuộn nằm bên ngoài modal, hãy để scroll behavior là
          outside.
        </p>
        <div>
          <div className=" gap-y-4">
            ...
            <RadioGroup
              ...
              onValueChange={(value) =>
                setScrollBehavior(value as "inside" | "outside")
              }
            >
            ...
            >
              <p>Modal demo về thanh scroll</p>
              <p>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam
                pulvinar risus non risus hendrerit venenatis. Pellentesque sit
                amet hendrerit risus, sed porttitor quam.
      ...
      <div>
        ...
        <p className="mb-3">
          Bạn có thể sử dụng Modal để hiển thị các form nhập liệu. Để làm điều
          này, bạn chỉ cần đặt các thành phần form bên trong ModalBody.
        </p>
        <div>
      ...
      <div>
        ...
        <p className="mb-3">
          Bạn có thể sử dụng thuộc tính backdrop để điều chỉnh phần đằng sau của
          Modal. Bạn có thể chọn giữa các kiểu như opaque - phần đằng sau tối
          lại, blur - phần đằng sau mờ, transparent - phần đằng sau giữ nguyên
          không đổi. Mặc định là opaque.
        </p>
        <div>
          <div className="flex flex-wrap gap-3">
            {backdrops.map((b) => (
          ...
          >
            <p>Modal demo về phần đằng sau</p>
            <p>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam
              pulvinar risus non risus hendrerit venenatis. Pellentesque sit
              amet hendrerit risus, sed porttitor quam.
      ...
      <div>
        ...
        <p className="mb-3">
          Bạn có thể kéo thả Modal, di chuyển chúng bằng cách sử dụng thuộc tính
          modalRef và modalProps.
        </p>
        <div>
      ...
      <div>
        ...
        <p className="mb-3">
          Bạn có thể tuỳ chỉnh style Tailwind css cho Modal bằng cách sử dụng
          className và classNames. Bạn có thể thay đổi màu sắc, kích thước, kiểu
          chữ, viền, đổ bóng, độ mờ của phần đằng sau, v.v.
        </p>
        <div>
          ...
          >
            <p>Modal demo về tuỳ chỉnh style css</p>
            <p>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam
              pulvinar risus non risus hendrerit venenatis. Pellentesque sit
              amet hendrerit risus, sed porttitor quam.
      ...
      <div>
        <div className="p-4 sm:p-6 lg:p-8">
          <h2 className="text-2xl font-bold mb-6 text-gray-800 dark:text-gray-100">
            Modal Props (Thuộc tính)
          </h2>
          <Table aria-label="Bảng thuộc tính của Modal HeroUI">
            <TableHeader>
              <TableColumn className="font-semibold text-lg text-gray-700 dark:text-gray-200">
                Prop
              </TableColumn>
              <TableColumn className="font-semibold text-lg text-gray-700 dark:text-gray-200">
                Type
            ...
            <TableBody>
              {modalPropsData.map((prop, index) => (
                <TableRow key={index}>
                  ...
                  <TableCell className="text-blue-600 dark:text-blue-300 font-mono text-sm">
                    {prop.type}
                  </TableCell>
                  <TableCell className="text-green-600 dark:text-green-300 font-mono text-sm">
                    {prop.default}
                  </TableCell>
